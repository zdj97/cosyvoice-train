...
instruct_list = ["You are a helpful assistant. 请用广东话表达。<|endofprompt|>",
                 ...
                 "You are a helpful assistant. 请用马来西亚语表达。<|endofprompt|>",
                 "You are a helpful assistant. 请用泰语表达。<|endofprompt|>",
                 "You are a helpful assistant. 请用西班牙语表达。<|endofprompt|>",
                 "You are a helpful assistant. 请用葡萄牙语表达。<|endofprompt|>",
                 "You are a helpful assistant. 请用新加坡语表达。<|endofprompt|>",
                 "You are a helpful assistant. 请用沙特阿拉伯语表达。<|endofprompt|>",
